    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-6">
        {[
          ...
          { title: 'How Affiliate Links Work', text: 'Links that include "?tag=YOURTAG-20" in the URL are affiliate links to Amazon.com. When you follow one of these links and make a purchase, Amazon pays us a small commission (typically 1–4% depending on the product category). The price you pay is identical whether you use our link or navigate to Amazon directly.' },
