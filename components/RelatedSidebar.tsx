...
export default function RelatedSidebar({ articles, currentSlug, title = 'MORE BUYING GUIDES' }: RelatedSidebarProps) {
  const filtered = currentSlug ? articles.filter((a) => a.slug !== currentSlug) : articles;

  return (
    <div className="sticky-sidebar">
      <p className="category-label text-[#666666] dark:text-gray-500 mb-3">{title}</p>
