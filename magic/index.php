...
define('CAMPAIGN_ID', "c411bc4f30c2313c7f1285e6d832e1a9");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '9c9a133f70128c5677976145ad140a71');
define('MP_PARAM_NAME', '_tb_clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '46a984ad30dca846fcdf265ce906a8e8');
define('CHECK_MCPROXY_VALUE', 'b5e92153fbff18c8cd7ef7e1cef6fffedf074a9f8aa5d5fe4cb22883373d14cc');
